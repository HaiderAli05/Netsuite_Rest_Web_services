...
module.exports = {
  ...
  MONGO_ATLAS_CONNECTION_URI: `mongodb+srv://${DB_USERNAME}:${DB_PASSWORD}@dedevtechcluster.8my2z.mongodb.net/${APP_MODE === `PROD` ? `dedev_db` : `dedev_db`}?retryWrites=true&w=majority`,
